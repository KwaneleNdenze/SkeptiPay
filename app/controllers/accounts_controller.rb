class AccountsController < ApplicationController
  ...
  private
    def account_params
      params.require(:account).permit(:first_name, :user_id, :last_name, :company_name, :sector, :street_address, :surburb, :city, :province, :card_number, :ccv, :expiry_date, :gender)
    end
end